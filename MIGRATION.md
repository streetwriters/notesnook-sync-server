...
NODE_ID=$(docker exec $CONTAINER_NAME /garage node id -q)
...
1.  **Cloudflare Tunnel Configuration**:
    ...
    *   *Do not point it to 3902 (Website Port) as this will break file uploads.*
...
2.  **CORS & Public Access Policy**:
    ...
    *Replace `http://172.17.0.1:3900` with your Unraid LAN IP if needed.*
